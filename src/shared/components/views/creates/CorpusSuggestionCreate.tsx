...
import { CorpusEditForm } from '../components';

const CorpusSuggestionCreate = (props: HistoryProps): ReactElement => {
  ...
  return (
    <Box className="bg-white shadow-sm p-10 mt-10">
      <Heading as="h1" className="text-3xl text-gray-800 mb-3">Create New Corpus Suggestion</Heading>
      {record ? (
        <CorpusEditForm
          view={View.CREATE}
          record={record}

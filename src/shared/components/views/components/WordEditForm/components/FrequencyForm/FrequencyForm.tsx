...
const FrequencyForm = ({ control, record }: FrequencyFormInterface): ReactElement => (
  <Box className="flex flex-col w-full">
    <FormHeader
      ...
      tooltip="A frequently used word is 5, while an infrequently used word is a 1."
    />
    <Controller
      render={({ onChange, ref }) => (
        <FrequencySlider ref={ref} onChange={onChange} defaultValue={get(record, 'frequency') || 1} />
      )}
      name="frequency"

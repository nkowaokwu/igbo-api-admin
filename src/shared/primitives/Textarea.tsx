...
import { Box, Textarea as ChakraTextarea, TextareaProps } from '@chakra-ui/react';
  ...
  (
    ...
    return (
      <Box className="relative w-full">
        <ChakraTextarea ref={inputRef} value={value} className={className} onChange={onChange} {...rest} />
        <DiacriticsBankPopup
